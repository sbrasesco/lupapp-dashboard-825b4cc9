...
const DeactivateCouponModal = ({ isOpen, onClose, onConfirm, couponName }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-cartaai-black border-cartaai-white/10">
        <DialogHeader>
          <DialogTitle className="text-cartaai-white">Confirmar desactivación</DialogTitle>
        </DialogHeader>
        <p className="text-cartaai-white">
          ¿Estás seguro de que quieres desactivar el cupón "{couponName}"?
        </p>
        <DialogFooter>
