  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "after:content-[''] after:block after:h-4 after:w-4 after:rounded-full after:shadow-lg",
        "after:transition-all after:duration-300",
        "data-[state=checked]:after:translate-x-1 data-[state=checked]:after:bg-[#00FF85]",
        "data-[state=unchecked]:after:translate-x-0 data-[state=unchecked]:after:bg-white"
      )}
    />
  </SwitchPrimitives.Root>
))
